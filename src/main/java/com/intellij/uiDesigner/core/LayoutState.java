...
public final class LayoutState {
    ...
    protected final Dimension[] myPreferredSizes;
    protected final Dimension[] myMinimumSizes;

    public LayoutState(GridLayoutManager layout, boolean ignoreInvisibleComponents) {
        List<Component> componentsList = new ArrayList<Component>(layout.getComponentCount());
        List<GridConstraints> constraintsList = new ArrayList<GridConstraints>(layout.getComponentCount());
